...
def init_dataset_kwargs(data, resolution = None):
    try:
        dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data, use_labels=True, max_size=None, xflip=False, resolution=resolution)
...
@click.option('--use-calibration', help='Whether to use poses from dataset_calibration_fitted.json', metavar='BOOL', type=bool, default=False, show_default=True)
...
def main(**kwargs):
    ...
    c.training_set_kwargs.use_calibration = opts.use_calibration
