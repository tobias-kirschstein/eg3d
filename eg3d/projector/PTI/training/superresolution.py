...
import torch
from eg3d.projector.PTI.training.networks_stylegan2 import Conv2dLayer, SynthesisLayer, ToRGBLayer
from eg3d.projector.PTI.torch_utils.ops import upfirdn2d
from eg3d.projector.PTI.torch_utils import persistence
from eg3d.projector.PTI.torch_utils import misc

from eg3d.projector.PTI.training.networks_stylegan2 import SynthesisBlock
import numpy as np
from eg3d.projector.PTI.training.networks_stylegan3 import SynthesisLayer as AFSynthesisLayer
